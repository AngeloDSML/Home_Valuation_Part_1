...
[Here](https://github.com/AngeloDSML/Home_Valuation_Part_1/blob/main/HomeValuation.ipynb) is a quick tutorial to show how to explore a homes sales dataset and run a couple of simple Machine Learning Models for Home Valuations.
